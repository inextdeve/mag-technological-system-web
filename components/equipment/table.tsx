...
export default function EquipmentTable() {
  ...
  const topContent = React.useMemo(() => {
    return (
      <div className="flex flex-col gap-4">
        <h2 className="font-bold text-xl">All Equipment</h2>
          ...
          <div className="flex gap-3 items-center justify-end w-full">
            ...
            >
              ...
              <Tab
                key="paused"
                title="Paused"
                className="data-[selected=true]:bg-danger"
              />
              <Tab
                key="all"
                title="All"
                className="data-[selected=true]:bg-[#06b6d425]"
              />
            </Tabs>
            ...
            <Input
              isClearable
              classNames={{
                base: "w-full sm:max-w-[190px] bg-white rounded-lg text-black",
  ...
  return (
    <div className="border border-yellow-600 p-4 rounded-lg mt-10">
      <Table
        isCompact
        removeWrapper
